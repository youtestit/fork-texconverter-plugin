...
public final class PostProcessingHelper {
    ...
    private static transient Log log = LogFactory
            .getLog(PostProcessingHelper.class);
    ...
    public static void buildCaptions(final List<CaptionImpl> captions,
        ...
        if (captions != null) {
            ...
            while (it.hasNext()) {
                ...
                if (floatEnv == null) {
                    log
                            .error("finish -> Found a caption outside of a floating environment,"
    ...
    public static void buildBibliography(
        ...
        while (it.hasNext()) {
            ...
            if (entry == null) {
                log
                        .error("buildBibliography -> a bibliography reference references a non-existant entry with the key "
    ...
    public static void buildBibliographyWithBibTex(
        ...
        if (bibTexLibraryFile == null) {
            log.error("runBibTex -> no BibTeX libary file defined");
            throw new TexSyntaxException(
        ...
        try {
            ...
            log.error("runBibTex -> Writing to file " + auxFile.getPath()
        ...
        if (log.isInfoEnabled()) {
            log.info("running BibTex to construct bibliography:\n"
    ...
    public static void buildIndex(final IndexImpl index,
            ...
            if (m.find()) {
                ...
                if ("(".equals(cmd)) {
                    ...
                    if (markRef != null) {
                        ...
                        log
                                .error("buildIndex -> missing start detected for index range "
                                        + label + ", ignored");
                    }
                    continue;
                } else {
        ...
        while (itIncomplRefLabels.hasNext()) {
            ...
            log
                    .error("buildIndex -> missing end index detected for index range "

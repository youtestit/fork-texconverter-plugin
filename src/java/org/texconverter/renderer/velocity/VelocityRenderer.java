...
public class VelocityRenderer implements Renderer {
    ...
    protected static final String TEMPLATE_BASEDIR = "plugin-resources/vm/";
    ...
    private void init(final String resourceDir) throws ConfigurationException {
        ...
        final InputStream istream = ResourceManager.getInstance().getResource(
                resDir + "plugin-resources/velocity.properties");
        if (istream == null) {
        ...
        props
                .put("runtime.log.logsystem.log4j.category",
                        "org.apache.velocity");
            ...
            while (itUsedAttr.hasNext()) {
                ...
                try {
                    ...
                    if (rv instanceof List) {
                        ...
                        log.error("renderNodeAttributes -> Method "
                                + sbMethName + " of " + aNode.getClass()
                                + " returns unhandled type " + rv.getClass());
                    }
                } catch (final NoSuchMethodException e) {
                    log.error("Attribute access for node "
    ...
    protected StringBuffer renderNode(final Node aNode,
        ...
        if (templateName != null) {
            ...
            log.debug("No velocity template for Node "
                    + aNode.getClass().getName());
        }
    ...
    protected String searchForTemplate(final Node aNode) {
        ...
        for (int i = 0; i < classes.length; i++) {
            ...
            log.debug("seaching for template " + templateDir + templateName
                    + ".vm");

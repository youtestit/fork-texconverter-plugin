...
import org.texconverter.dom.Paragraph;
import org.texconverter.dom.Section;

/**
 * @author tfrana
 */
public class ParagraphImpl extends NodeWithChildsImpl implements Paragraph {
    ...
    public boolean isEndedBy(final Node node) {
        return node instanceof Paragraph || node instanceof Section;
    }
}

 ...
 * @author tfrana
 */
public final class TableHandler implements CommandHandler {
    ...
    public void handle(final Command cmd, final AbstractBuilder builder) {
        ...
        if (builder instanceof TableBuilder) {
            final TableBuilder tbuilder = (TableBuilder) builder;

            // TODO handle hline and multicolumn
            if ("\\".equals(cmd.getName())) {
                tbuilder.startNewRow();
            }
        }
    }
}

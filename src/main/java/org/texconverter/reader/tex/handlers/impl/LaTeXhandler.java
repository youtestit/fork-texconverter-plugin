...
import org.texconverter.dom.impl.LatexImpl;
 ...
 * @author pguillerm
 */
public class LaTeXhandler implements CommandHandler {

    /**
     * {@inheritDoc}
     */
    public void handle(final Command cmd, final AbstractBuilder builder) {
        if ("LaTeX".equals(cmd.getName())) {
            builder.consumeNode(new LatexImpl(), false);
        }
    }
}

...
import org.texconverter.dom.impl.VerbatimImpl;
 ...
 * @author tfrana
 */
public class VerbatimHandler implements CommandHandler {
    ...
    public void handle(final Command cmd, final AbstractBuilder builder) {
        ...
        if ("verb".equals(cmd.getName())) {
            VerbatimImpl verbatim = new VerbatimImpl((String) cmd
                    .getMandatoryArgs().get(0));
            builder.consumeNode(verbatim, false);
        }
    }
